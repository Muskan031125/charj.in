...
$routes->group('admin', ['namespace' => 'App\Controllers\Admin'], function ($routes) {
    ...
    $routes->post('vehicles/(:num)/images/upload',       'VehicleAdminController::uploadImage/$1');
    $routes->get('vehicles/(:num)/images/delete/(:num)', 'VehicleAdminController::deleteImage/$1/$2');
