...
<div class="mx-auto max-w-7xl px-4 py-8 pb-4 md:pb-0">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sr-stagger">
        ...
        ?>
        <article class="flex flex-col overflow-hidden rounded-2xl transition hover:-translate-y-1 duration-300 card-hover" style="background:#FFFFFF;border:1px solid rgba(0,168,150,.12);box-shadow:0 2px 8px rgba(0,0,0,.04)">
            ...
            <div class="flex flex-1 flex-col p-5">
                ...
                <!-- Title -->
                <h2 class="text-base font-bold leading-snug" style="color:#0F172A">
                    <a href="/news/<?= esc($article['slug']) ?>" class="transition-colors" onmouseover="this.style.color='#00A896'" onmouseout="this.style.color=''">
                        <?= esc($article['title']) ?>
                    </a>
                </h2>
