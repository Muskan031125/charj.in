...
<div class="mx-auto max-w-7xl px-4 pb-20 md:pb-16">
    ...
    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="flex flex-col rounded-2xl p-5 transition card-hover" style="background:#FFFFFF;border:1px solid rgba(0,168,150,.14);cursor:pointer"
             onclick="if(!event.target.closest('a')) window.location.href='/dealers/<?= esc($dealer['slug'] ?? $dealer['id']) ?>'">
