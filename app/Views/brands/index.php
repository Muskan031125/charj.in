...
<section style="background:linear-gradient(160deg,#F0FFF4 0%,#FFFFFF 50%,#EEFFF3 100%);border-bottom:1px solid rgba(0,168,150,.12)">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 pb-8 sm:pb-10 text-center">
...
<section class="py-8 md:py-10">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-2 gap-3 sm:gap-5 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
      ...
      ?>
      <article class="group relative flex flex-col overflow-hidden rounded-2xl transition-all duration-250"
               style="background:#FFFFFF;border:1.5px solid rgba(0,230,118,.1);box-shadow:0 1px 5px rgba(0,0,0,.04)"
        ...
        <div class="flex flex-1 flex-col p-4 sm:p-5">
          ...
          <a href="<?= base_url('brands/'.esc($slug)) ?>"
             class="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg transition-all duration-150"
