  ...
  <div class="max-w-5xl mx-auto px-4">
    ...
    <div class="mb-6">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="group relative rounded-2xl bg-white border border-slate-100 hover:border-green-200 hover:shadow-lg hover:shadow-green-50 transition-all overflow-hidden cursor-pointer"
             onclick="if(!event.target.closest('a, form, button')) window.location.href='<?= site_url('vehicles/' . esc($v['slug'] ?? $v['id'])) ?>'">
          <?php
