...
<div class="min-h-screen bg-slate-50">
  ...
  <!-- ════════════════════════════════════════════════════════════
       HEADER
  ═════════════════════════════════════════════════════════════ -->
  <div class="hero-sm bg-charj-navy text-white pt-12 sm:pt-20 md:pt-32 pb-12 px-4">
  ...
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <!-- ════════════════════════════════════════════════════════
         A–Z NAVIGATION BAR
    ═════════════════════════════════════════════════════════ -->
    <nav class="bg-white rounded-2xl shadow-sm border border-slate-100 px-4 py-4 mb-8 sticky top-20 md:top-32 z-30" aria-label="A-Z glossary navigation">
