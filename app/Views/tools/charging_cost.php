...
<div class="hero-bg min-h-[60vh]"
  ...
  <div class="relative max-w-5xl mx-auto px-4 pt-28 pb-20">
    ...
    <!-- Desktop: sliders left, results right (sticky). Mobile: stacked, circle first. -->
    <div class="lg:grid lg:grid-cols-[1fr_400px] lg:gap-8 lg:items-start">

      <!-- ═══ LEFT: Sliders ═══ -->
      <div class="order-2 lg:order-1">
        <div class="rounded-3xl p-6 sm:p-8 space-y-7 fadeInUp-3"
        ...
        <!-- CTAs (desktop: under the sliders) -->
        <div class="hidden lg:grid grid-cols-2 gap-3 mt-6">
      ...
      <!-- ═══ RIGHT: Results ═══ -->
      <div class="order-1 lg:order-2 lg:sticky lg:top-24 space-y-4 mb-6 lg:mb-0">

        <!-- Big cost circle -->
        <div class="flex justify-center fadeInUp-2">
          <div class="relative">
        ...
        <!-- Stats grid -->
        <div class="grid grid-cols-2 gap-3 fadeInUp-4">
        ...
        <!-- CTAs (mobile only, under results) -->
        ...
        <p class="text-center text-xs" style="color:#94A3B8">Petrol cost comparison uses ₹2.10/km average. Electricity tariff varies by state and DISCOM slab.</p>
      </div>
