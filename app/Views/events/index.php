...
<div class="hero-sm min-h-screen bg-slate-50 pt-16 sm:pt-20 md:pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <?php if ($featuredEvents): ?>
                <div class="lg:col-span-1">
                    <div class="bg-gradient-to-b from-emerald-50 to-green-50 rounded-2xl p-6 border-2 border-emerald-200 sticky top-24 md:top-36">
