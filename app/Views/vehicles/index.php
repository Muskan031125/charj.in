...
<div class="mx-auto max-w-7xl px-4 sm:px-6 py-6">
  <div class="lg:grid lg:grid-cols-[260px_1fr] lg:gap-6 flex flex-col gap-5">
    ...
    <aside class="hidden lg:block w-72 flex-shrink-0 self-start sticky top-24 md:top-36" aria-label="Filter panel">
        ...
        <form method="GET" action="<?= base_url('vehicles') ?>" x-data="filterForm()" class="divide-y" style="--tw-divide-opacity:1;border-color:rgba(0,168,150,.06)">
          ...
          <div class="px-5 py-4">
            ...
            <select id="sidebar_sort" name="sort"
              ...
              <option value="range_desc" <?= $selectedSort==='range_desc'?'selected':'' ?>>Best Range</option>
    ...
    <main class="flex-1 min-w-0">
      ...
      <div class="flex flex-wrap items-center gap-2 mb-4 sticky top-20 md:top-32 z-20 rounded-2xl px-3 py-2.5"
      ...
      <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 sr-stagger">
