...
<style>
input[type=range]{-webkit-appearance:none;appearance:none;height:6px;border-radius:9999px;outline:none;cursor:pointer;background:linear-gradient(90deg,#00C060,#A7F3D0)}
input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;width:20px;height:20px;border-radius:50%;background:linear-gradient(135deg,#00E676,#00C060);box-shadow:0 2px 8px rgba(0,200,100,.4),0 0 0 3px #fff;cursor:pointer;transition:transform .15s}
input[type=range]::-webkit-slider-thumb:hover{transform:scale(1.15)}
input[type=range]::-moz-range-thumb{width:20px;height:20px;border-radius:50%;border:none;background:linear-gradient(135deg,#00E676,#00C060);box-shadow:0 2px 8px rgba(0,200,100,.4),0 0 0 3px #fff;cursor:pointer;transition:transform .15s}
...
<div class="min-h-screen" style="background:#F5FFF7">
  ...
  <!-- Hero -->
  <div class="hero-sm pt-24 md:pt-32 pb-8" style="background:linear-gradient(160deg,#F0FFF9 0%,#EAFFF4 50%,#F7FFFE 100%);border-bottom:1px solid rgba(0,168,150,.12)">
