...
<div x-data="subsidyCalc()" x-init="initRange()" class="pb-16" style="background:linear-gradient(180deg,#f0fdf4 0%,#f8fafc 280px)">
  ...
  <!-- ── STEP PROGRESS BAR ── -->
  <div class="sticky top-16 md:top-28 z-40 shadow-sm" style="background:rgba(255,255,255,.97);backdrop-filter:blur(12px);border-bottom:1px solid rgba(0,230,118,.1)">
