...
$breadcrumbs = [
    'Charging Stations' => '/admin/charging',
    ($isEdit ? 'Edit' : 'Add Station') => '',
];
$formAction = $isEdit
    ? '/admin/charging/update/' . ($station['id'] ?? '')
    : '/admin/charging/store';
  ...
  <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    ...
    <div class="space-y-6">
      ...
      <div class="rounded-2xl bg-red-50 border border-red-200 p-5">
        ...
        <a href="/admin/charging/delete/<?= esc($station['id']) ?>"
           onclick="return confirm('Permanently delete this station?')"
           class="block w-full rounded-xl border border-red-300 bg-white px-4 py-2 text-center text-sm font-semibold text-red-600 hover:bg-red-100 transition-colors">
          Delete Station
        </a>
      </div>
      <?php endif; ?>
