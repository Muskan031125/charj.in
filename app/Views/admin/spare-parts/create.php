...
<div class="mb-5 flex items-center gap-3">
    ...
    <h1 class="text-2xl font-black text-slate-900">Add Spare Part</h1>
</div>
...
<form method="post" action="/admin/spare-parts/store">
    <?= csrf_field() ?>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="part_name" value="<?= esc(old('part_name')) ?>" required
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="part_number" value="<?= esc(old('part_number')) ?>"
                        ...
                        <div>
                            ...
                            <input type="number" name="price" value="<?= esc(old('price')) ?>" step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="compatible_models" value="<?= esc(old('compatible_models')) ?>"
                               placeholder="e.g. Ather 450X, Ola S1 Pro"
                               class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-slate-600">Image URL</label>
                        <input type="url" name="image_url" value="<?= esc(old('image_url')) ?>" placeholder="https://..."
                               class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none">
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="vendor_name" value="<?= esc(old('vendor_name')) ?>"
                                   class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="mb-1 block text-xs font-semibold text-slate-600">Vendor Contact</label>
                            <input type="text" name="vendor_contact" value="<?= esc(old('vendor_contact')) ?>"
                                   class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none">
                        </div>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-slate-600">Vendor URL</label>
                        <input type="url" name="vendor_url" value="<?= esc(old('vendor_url')) ?>" placeholder="https://..."
                               class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3 pt-1">
                        <input type="checkbox" name="in_stock" id="in_stock" value="1" checked class="h-4 w-4 rounded border-slate-300 text-emerald-600">
